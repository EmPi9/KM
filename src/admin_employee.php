                        ...
                        <div id="edit<?= $user['id'] ?>" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
                            <div class="relative w-full h-full max-w-md md:h-auto">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <form action="../controllers/editRole.php" method="post" enctype="multipart/form-data">
                                    <input id="id" name="id" type="hidden" value="<?=$user['id']?>">
                                      <div class="px-6 py-6 mx-auto lg:px-8">
                                          <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Изменить роль пользователя # <?= $user['id'] ?> </h3>
                                            <p>
                                            Изменить роль пользователя <br> <?= $user['username'] ?> на:
                                            </p>
