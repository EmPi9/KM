    ...
    <div class="w-full max-w-6xl rounded bg-white shadow-xl p-10 lg:p-20 mx-auto text-gray-800 relative md:text-left">
        <div class="md:flex items-center -mx-10">
            <div class="w-full md:w-1/2 px-10 mb-10 md:mb-0">
                <div class="relative">
                    <img src="../assets/img/product_KM.png" class="w-full relative z-10" alt="">
                    <div class="border-4 border-yellow-200 absolute top-10 bottom-10 left-10 right-10 z-0"></div>
                </div>
            </div>
            <div class="w-full md:w-1/2 px-10">
                <div class="mb-10">
                    <h1 class="font-bold uppercase text-4xl mb-20">Изготовление распределенной интеллектуальной системы видеонаблюдения на объектах нефтедобычи.</h1>
                    <p class="text-3xl font-medium mb-10">Заказчик: АО "Булгарнефть"</p>
                    <p class="text-3xl font-medium mb-20">Год исполнения: 2023 год</p>
                </div>
                <div>
                    <div class="inline-block align-bottom">
                        <a href="../src/projects.html" class="bg-[#392D88] text-white font-bold px-10 py-4 rounded-xl border-2 border-[#392D88] hover:bg-white hover:text-[#392D88] transition-all duration-700">Назад</a>
                    </div>
                </div>
            </div>
        </div>
