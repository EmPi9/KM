...
$projects = getProjects() ?>
    ...
    >
      ...
      >
        ...
        <!-- Modal body -->
        <form action="../controllers/archivingProject.php" method="post" enctype="multipart/form-data" >
        ...
        <div class="mt-4 mb-6">
          ...
          >
            ...
            Архивированние заверщенного проекта с кодом № <?= $project['id_project']?>.
          </p>
          <!-- Modal description -->
          <p class="text-sm text-gray-700 dark:text-gray-400">
            Вы точно хотите архивировать завершенные проекты, <?= $project['name_project']?>. 
          </p>
        </div>
        ...
        >
          ...
          <button type="submit" class="w-full px-5 py-3 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
            Архивировать
          </button>
          </form>
        </footer>
    ...
    >
      ...
      >
        ...
        <!-- Modal body -->
        <form action="../controllers/returnProject.php" method="post" enctype="multipart/form-data" >
            <input id="id_project" name="id_project" type="hidden" value="<?=$project['id_project']?>">
        <div class="mt-4 mb-6">
          <!-- Modal title -->
          <p
          ...
          >
            ...
            Вернуть на сайт заверщенный проект с кодом № <?= $project['id_project']?>.
          </p>
          <!-- Modal description -->
          <p class="text-sm text-gray-700 dark:text-gray-400">
            Вы точно хотите вернуть на сайт завершенные проекты, <?= $project['name_project']?>. 
          </p>
        </div>
