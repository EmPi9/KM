...
<footer class="text-gray-900 body-font p-6 element_animation bottom_animation">
            <div class="max-w-[1820px] mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
              ...
              <div class="md:ml-auto md:mr-auto flex flex-col flex-wrap gap-3 text-base justify-center underline-animation text-gray-900 hover:text-gray-700 relative transition duration-300 ease-in-out md:my-2"">
                ...
                <a href="./send_request.php" class="bg-[#392D88] text-white text-center font-bold px-10 py-4 rounded-xl border-2 border-[#392D88] hover:bg-white hover:text-[#392D88] transition-all duration-700">Оставить заявку</a>
              </div>
            </div>
          </footer> 
